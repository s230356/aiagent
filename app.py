...
b = st.number_input(' 크레아틴카나제 검사 결과 ', value=0.0 )     
c = st.number_input(' 박출계수  ', value=0.0 ) 
d = st.number_input(' 고혈압 여부 ', value=0.0 ) 
e = st.number_input(' 혈중 크레아틴 레벨 ', value=0.0 ) 
f = st.number_input(' 혈중 나트륨 레벨 ', value=0.0 ) 
g = st.number_input(' 성별', value=0.0 ) 
h = st.number_input('흡연 여부 ', value=0.0 ) 
i = st.number_input('나이 ', value=0.0 ) 
